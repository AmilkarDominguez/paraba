                ...
                <div class="modal-body">
                        <div class="modal-body">
                            <div class="md-form mb-3">
                                ...
                                <input type="text" class="form-control rounded" onkeyup="Mayus(this);" id="name" name="name" placeholder="Título"
                                    required>
                            ...
                            <div class="md-form mb-3">
                                ...
                                <textarea  type="text" class="form-control rounded" rows="4" id="description" name="description" placeholder="Contenido"></textarea>  
                            </div> 
                            <div class="md-form mb-3">
...
@endsection
@section('scripts')
<script src="{{ URL::asset('js/scripts/notifications.js') }}"></script>
<script>
title_modal_data="Notificaciones";
</script>
@endsection