...
<div class="row">
    <div align='center' class="col s12">
        <h5 class="teal-text text-darken-4">Lugares</h5>
    </div>
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (key, value) {
                ...
                code += '<a href="'+value.link+'" target="_blank"  class="flow-text teal-text text-darken-4"><i class="fas fa-map-signs"></i></a>';
